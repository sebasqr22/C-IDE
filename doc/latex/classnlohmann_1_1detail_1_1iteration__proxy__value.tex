\doxysection{nlohmann\+::detail\+::iteration\+\_\+proxy\+\_\+value$<$ Iterator\+Type $>$ Class Template Reference}
...
using {\bfseries string\+\_\+type} = typename std\+::remove\+\_\+cv$<$ typename std\+::remove\+\_\+reference$<$ decltype(std\+::declval$<$ Iterator\+Type $>$().\textbf{ key}()) $>$\+::type $>$\+::type
...
\textbf{ iteration\+\_\+proxy\+\_\+value} \& \textbf{ operator$\ast$} ()
...
\textbf{ iteration\+\_\+proxy\+\_\+value} \& \textbf{ operator++} ()
...
bool \textbf{ operator==} (const \textbf{ iteration\+\_\+proxy\+\_\+value} \&o) const
...
const string\+\_\+type \& \textbf{ key} () const
...
Iterator\+Type\+::reference \textbf{ value} () const
