...
\item 
struct \textbf{ boundaries}
\item 
struct \textbf{ cached\+\_\+power}
\item 
struct \textbf{ diyfp}
...
\item 
{\footnotesize template$<$typename Float\+Type $>$ }\\\textbf{ boundaries} \textbf{ compute\+\_\+boundaries} (Float\+Type value)
\item 
\textbf{ cached\+\_\+power} \textbf{ get\+\_\+cached\+\_\+power\+\_\+for\+\_\+binary\+\_\+exponent} (int e)
\item 
int \textbf{ find\+\_\+largest\+\_\+pow10} (const std\+::uint32\+\_\+t n, std\+::uint32\+\_\+t \&pow10)
\item 
...
\item 
void \textbf{ grisu2\+\_\+digit\+\_\+gen} (char $\ast$buffer, int \&length, int \&decimal\+\_\+exponent, \textbf{ diyfp} M\+\_\+minus, \textbf{ diyfp} w, \textbf{ diyfp} M\+\_\+plus)
\item 
void \textbf{ grisu2} (char $\ast$buf, int \&len, int \&decimal\+\_\+exponent, \textbf{ diyfp} m\+\_\+minus, \textbf{ diyfp} v, \textbf{ diyfp} m\+\_\+plus)
\item 
{\footnotesize template$<$typename Float\+Type $>$ }\\void \textbf{ grisu2} (char $\ast$buf, int \&len, int \&decimal\+\_\+exponent, Float\+Type value)
\item 
JSON\+\_\+\+HEDLEY\+\_\+\+RETURNS\+\_\+\+NON\+\_\+\+NULL char $\ast$ \textbf{ append\+\_\+exponent} (char $\ast$buf, int e)
\begin{DoxyCompactList}\small\item\em appends a decimal representation of e to buf \end{DoxyCompactList}\item 
JSON\+\_\+\+HEDLEY\+\_\+\+RETURNS\+\_\+\+NON\+\_\+\+NULL char $\ast$ \textbf{ format\+\_\+buffer} (char $\ast$buf, int len, int decimal\+\_\+exponent, int min\+\_\+exp, int max\+\_\+exp)
...
This implementation is a slightly modified version of the reference implementation which may be obtained from {\texttt{ http\+://florian.\+loitsch.\+com/publications}} (bench.\+tar.\+gz).

The code is distributed under the MIT license, Copyright (c) 2009 Florian Loitsch.

For a detailed description of the algorithm see\+:

[1] Loitsch, \char`\"{}\+Printing Floating-\/\+Point Numbers Quickly and Accurately with     Integers\char`\"{}, Proceedings of the ACM SIGPLAN 2010 Conference on Programming Language Design and Implementation, PLDI 2010 [2] Burger, Dybvig, \char`\"{}\+Printing Floating-\/\+Point Numbers Quickly and Accurately\char`\"{}, Proceedings of the ACM SIGPLAN 1996 Conference on Programming Language Design and Implementation, PLDI 1996 
...
\doxysubsubsection{append\_exponent()}
...
\doxysubsubsection{compute\_boundaries()}
{\footnotesize\ttfamily template$<$typename Float\+Type $>$ \\
\textbf{ boundaries} nlohmann\+::detail\+::dtoa\+\_\+impl\+::compute\+\_\+boundaries (\begin{DoxyParamCaption}\item[{Float\+Type}]{value }\end{DoxyParamCaption})}
...
\doxysubsubsection{find\_largest\_pow10()}
...
\doxysubsubsection{format\_buffer()}
...
If v is in the range [10$^\wedge$min\+\_\+exp, 10$^\wedge$max\+\_\+exp) it will be printed in fixed-\/point notation. Otherwise it will be printed in exponential notation.
...
\doxysubsubsection{get\_cached\_power\_for\_binary\_exponent()}
{\footnotesize\ttfamily \textbf{ cached\+\_\+power} nlohmann\+::detail\+::dtoa\+\_\+impl\+::get\+\_\+cached\+\_\+power\+\_\+for\+\_\+binary\+\_\+exponent (\begin{DoxyParamCaption}\item[{int}]{e }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

For a normalized diyfp w = f $\ast$ 2$^\wedge$e, this function returns a (normalized) cached power-\/of-\/ten c = f\+\_\+c $\ast$ 2$^\wedge$e\+\_\+c, such that the exponent of the product w $\ast$ c satisfies (Definition 3.\+2 from [1]) \begin{DoxyVerb} alpha <= e_c + e + q <= gamma.
\end{DoxyVerb}
...
\doxysubsubsection{grisu2()\hspace{0.1cm}{\footnotesize\ttfamily [1/2]}}
{\footnotesize\ttfamily void nlohmann\+::detail\+::dtoa\+\_\+impl\+::grisu2 (\begin{DoxyParamCaption}\item[{char $\ast$}]{buf,  }\item[{int \&}]{len,  }\item[{int \&}]{decimal\+\_\+exponent,  }\item[{\textbf{ diyfp}}]{m\+\_\+minus,  }\item[{\textbf{ diyfp}}]{v,  }\item[{\textbf{ diyfp}}]{m\+\_\+plus }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\index{nlohmann::detail::dtoa\_impl@{nlohmann::detail::dtoa\_impl}!grisu2@{grisu2}}
\index{grisu2@{grisu2}!nlohmann::detail::dtoa\_impl@{nlohmann::detail::dtoa\_impl}}
\doxysubsubsection{grisu2()\hspace{0.1cm}{\footnotesize\ttfamily [2/2]}}
{\footnotesize\ttfamily template$<$typename Float\+Type $>$ \\
...
\doxysubsubsection{grisu2\_digit\_gen()}
{\footnotesize\ttfamily void nlohmann\+::detail\+::dtoa\+\_\+impl\+::grisu2\+\_\+digit\+\_\+gen (\begin{DoxyParamCaption}\item[{char $\ast$}]{buffer,  }\item[{int \&}]{length,  }\item[{int \&}]{decimal\+\_\+exponent,  }\item[{\textbf{ diyfp}}]{M\+\_\+minus,  }\item[{\textbf{ diyfp}}]{w,  }\item[{\textbf{ diyfp}}]{M\+\_\+plus }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
